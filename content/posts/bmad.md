+++
authors = ["Daniel Vale"]
title = "BMAD Method vs Vibe Coding"
date = "2026-01-22"
description = "Cet article compare deux approches du développement assisté par IA — le Vibe Coding intuitif et la méthode BMAD structurée — pour déterminer quand utiliser chacune selon le contexte de son projet"
tags = [
    "IA",
    "Intelligence",
    "Artificielle",
...
| --------------- | --------------------------------------------- |
| **Vibe Coding** | Intuitive, conversationnelle, improvisée      |
| **BMAD Method** | Structurée, agentique, orientée documentation |

---

## 🌊 Qu'est-ce que le Vibe Coding ?

Le **vibe coding** représente l'approche informelle et intuitive du développement assisté par IA. Concrètement, cela signifie :

- Discuter de manière décontractée avec les assistants IA
- Improviser ses prompts selon les besoins immédiats
- Se fier à son instinct et son intuition

### ⚠️ Les limites du Vibe Coding

| Problème                       | Impact                                                            |
| ------------------------------ | ----------------------------------------------------------------- |
| **Dégradation du contexte**    | L'IA "oublie" les décisions précédentes au fil de la conversation |
| **Incohérence architecturale** | Chaque session repart de zéro, pas de vision globale              |
...
#### 1. 🤖 Planification Agentique

Des agents IA spécialisés collaborent pour créer une documentation solide :

```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│   ANALYST   │ → │     PM      │ → │  ARCHITECT  │
│             │    │             │    │             │
│ Comprend le │    │ Rédige le   │    │ Définit la  │
│ besoin      │    │ PRD         │    │ structure   │
└─────────────┘    └─────────────┘    └─────────────┘
```

#### 2. 📋 Développement à Contexte Optimisé

L'agent **Scrum Master** transforme les plans en stories hyper-détaillées contenant tout ce dont l'agent Dev a besoin.

### Pourquoi ça fonctionne ?

Au cœur de BMAD, c'est une méthode puissante pour **dompter le chaos du vibe coding** et le remplacer par un workflow structuré basé sur des personas. Plutôt qu'une conversation unique avec un LLM, BMAD organise tout le processus autour d'**agents IA spécialisés distincts**.

---

## ⚖️ Quand utiliser chaque approche ?

### ✅ Vibe Coding — Idéal pour :
...
- 👥 **Équipes distribuées** et projets complexes
- 🏢 **Architectures d'entreprise** (microservices, systèmes distribués)
- 📚 Projets nécessitant une documentation exhaustive
...
| Phase          | Persona/Prompt adapté                    |
| -------------- | ---------------------------------------- |
| Conception     | "Tu es un architecte logiciel senior..." |
| Planning       | "Tu es un Scrum Master expérimenté..."   |
